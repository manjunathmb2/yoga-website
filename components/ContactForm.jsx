  ...
  return (
    <section id="contact" className="contact">
      ...
      <style>{`
        ...
        .contact-copy h2 { font-size: clamp(2rem, 4vw, 2.6rem); color: var(--sage-deep); margin-bottom: 18px; }
        .contact-copy p { color: var(--ink-soft); margin-bottom: 16px; max-width: 440px; }
        .contact-alt a { color: var(--clay-deep); font-weight: 600; }
        ...
        .form-success {
          ...
          text-align: center; border: 1px solid var(--cream-dark);
        }
        .form-success h3 { font-size: 1.6rem; color: var(--sage-deep); margin-bottom: 10px; }

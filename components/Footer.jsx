...
export default function Footer() {
  return (
    <footer className="footer">
      ...
      <style>{`
        .footer { background: var(--sage-deep); color: var(--cream); padding: 56px 0 28px; }
        ...
        .footer-tag { color: var(--sage-light); font-size: .9rem; }
        .footer-links { display: flex; gap: 26px; flex-wrap: wrap; align-items: center; }
        .footer-links a { color: var(--cream); font-size: .92rem; }
        .footer-links a:hover { color: var(--clay); }
        .footer-bottom { padding-top: 22px; font-size: .82rem; color: var(--sage-light); }
      `}</style>
    </footer>
  );
}
